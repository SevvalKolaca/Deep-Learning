...
class MBConvN(nn.Module):
    ...
    def __init__(self, n_in, n_out, kernel_size=3,
        ...
        self.expand = nn.Identity() if (expansion_factor == 1) else ConvBnAct(n_in, intermediate_channels,
                                                                              kernel_size=1)
...
class EfficientNet(nn.Module):
    def __init__(self, width_mult=1, depth_mult=1,
        ...
        self.features = self.feature_extractor(width_mult, depth_mult, last_channel)
    ...
    @staticmethod
    def feature_extractor(width_mult, depth_mult, last_channel):
